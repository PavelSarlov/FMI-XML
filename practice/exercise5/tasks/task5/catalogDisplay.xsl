...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <!-- Дефинираме си параметъра -->
        <xsl:param name="track" select="'Track: '"/>
            ...
            <body>
                ...
                <table border="1px solid">
                    <xsl:for-each select=".//track">
                        ...
                        <!-- Използваме параметъра в конкатенация със стойността на track -->
                        <tr>
                            <td><xsl:value-of select="concat($track, text())"/></td>
                        </tr>
                    </xsl:for-each>
                </table>
