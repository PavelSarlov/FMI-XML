...
public class Main {
    ...
    private static void printEvent(XMLStreamReader xmlr) {
        switch (xmlr.getEventType()) {
            ...
            case XMLStreamConstants.CHARACTERS:
                ...
                System.out.print(new String(xmlr.getTextCharacters(), start, length).toUpperCase()); // Трябва да са с
                                                                                                     // главни букви.
                break;
    ...
    private static void printAttribute(XMLStreamReader xmlr, int index) {
        ...
        printName(xmlr.getAttributePrefix(index), xmlr.getAttributeNamespace(index), xmlr.getAttributeLocalName(index));
